...
async fn handle_short_position_sl(
    position_key: &Pubkey,
    ...
    if oracle_price.price <= position.stop_loss_limit_price {
        ...
        program
            ...
            .accounts(adrena_abi::accounts::ClosePositionShort {
                ...
                staking_reward_token_custody_token_account: staking_reward_token_custody
                    .token_account,
...
async fn handle_long_position_sl(
    position_key: &Pubkey,
    position: &adrena_abi::types::Position,
    oracle_price: &utils::oracle_price::OraclePrice,
    indexed_custodies: &Arc<RwLock<HashMap<Pubkey, adrena_abi::types::Custody>>>,
